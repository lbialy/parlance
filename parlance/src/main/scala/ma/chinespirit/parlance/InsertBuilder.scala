...
class InsertBuilder[EC, E] @scala.annotation.publicInBinary private[parlance] (
    private[parlance] val tableName: String,
    private[parlance] val ecColNames: IArray[String],
    private[parlance] val ecCodec: DbCodec[EC],
    private[parlance] val eCodec: DbCodec[E],
    private[parlance] val eColNames: IArray[String],
    private[parlance] val eElemCodecs: IArray[DbCodec[?]],
    private[parlance] val pkColName: String,
    private[parlance] val idIndex: Int
):
