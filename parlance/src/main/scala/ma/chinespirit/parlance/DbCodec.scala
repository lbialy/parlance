...
object DbCodec:
  ...
  private[parlance] def productQueryRepr[Mets: Type](
  ...
  private[parlance] def buildColsExpr[Mets: Type](
  ...
  private[parlance] def productReadSingle[E: Type, Mets: Type](
      rs: Expr[ResultSet],
  ...
  private[parlance] def productReadOption[E: Type, Mets: Type](
      rs: Expr[ResultSet],
      m: Expr[Mirror.ProductOf[E]],
      res: Vector[Expr[Any]],
      pos: Expr[Int]
  ...
  private[parlance] def productWriteSingle[E: Type, Mets: Type](
      e: Expr[E],
