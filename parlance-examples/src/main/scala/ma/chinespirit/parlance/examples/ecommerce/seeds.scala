...
object SeedData:
  def insertAll()(using DbCon[Postgres], AppContext): Unit =
    Category.repo.rawInsertAll(Seq(
    ...
    ProductVariant.repo.rawInsertAll(Seq(
    ...
    Customer.repo.rawInsertAll(Seq(
    ...
    OrderItem.repo.rawInsertAll(Seq(
    ...
    Wishlist.repo.rawInsertAll(Seq(
